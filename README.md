...
Este projeto é uma API REST que simula um pequeno sistema bancário, essa implementação foi um desafio da @cubosacademy que proporcionou um grande aprendizado.
...
Antes de executar, é necessário baixar e instalar o NodeJS, após a instalação execute o seguinte comando para instalar as dependências:
...
![image](https://github.com/Joao-NSM/Joao-NSM/assets/142268560/492a90f9-522a-4b26-9dda-f53c4291dad4)
...
- Esse endpoint é responsável por:
    ...
    - Verificar se a senha do banco foi informada no query params na url
...
- Esse endpoint é responsável por:
    ...
    - Verificar se o CPF é um campo único.
    - Verificar se o E-mail é um campo único.
